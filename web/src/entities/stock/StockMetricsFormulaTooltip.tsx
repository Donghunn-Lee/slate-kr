...
export const StockMetricsFormulaTooltip = ({
  source,
  bpsYear,
}: StockMetricsFormulaTooltipProps) => (
  <Tooltip>
    ...
    <TooltipContent side="left" className="max-w-xs px-3 py-2 text-left">
      <div className="space-y-2">
        ...
        <section className="space-y-0.5">
          ...
          {bpsYear !== null && (
            <p>
              <span className="font-semibold">BPS 출처</span>: {bpsYear}년 연간
              사업보고서 기준
            </p>
          )}
          <p>
        ...
        <section className="space-y-1 border-t border-primary-foreground/20 dark:border-foreground/15 pt-1.5 text-micro text-primary-foreground/80 dark:text-foreground/70">
