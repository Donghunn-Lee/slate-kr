...
export const CheckpointBadge = ({ type }: CheckpointBadgeProps) => (
  <span
    className={`inline-flex shrink-0 items-center whitespace-nowrap rounded-sm border border-current/30 px-1 py-0.5 text-micro font-medium md:px-1.5 md:text-caption ${DISCLOSURE_TYPE_BADGE_CLASSES[type]}`}
  >
