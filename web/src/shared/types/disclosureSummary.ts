...
export const DisclosureSummaryContentSchema = z.object({
  ...
  facts: z
    ...
    .max(18)
    .describe(
      "공시 본문에 나온 핵심 항목. 사안의 규모·시점·당사자를 파악하는 데 필요한 것을 우선합니다. 최대 18개. 본문에 해당 정보가 없으면 빈 배열로 둡니다. 억지로 채우지 않습니다. 값이 같거나 의미가 겹치는 항목을 중복해서 넣지 않습니다. 이 공시를 제출한 회사 자신의 이름은 넣지 않습니다. 단, 계약 상대방·취득 대상·보고자처럼 다른 주체의 이름은 넣습니다.",
    ),
  detail: z
    .string()
    .describe(
